    ...
    VkPhysicalDeviceVulkan14Properties* to)
{
    ...
    *to = *from;
    ...
    {
        to->pCopySrcLayouts = (VkImageLayout*)alloc->dupArray(from->pCopySrcLayouts, from->copySrcLayoutCount * sizeof(VkImageLayout));
    }
    to->pCopyDstLayouts = nullptr;
    if (from->pCopyDstLayouts)
    {
        to->pCopyDstLayouts = (VkImageLayout*)alloc->dupArray(from->pCopyDstLayouts, from->copyDstLayoutCount * sizeof(VkImageLayout));
    }
    memcpy(to->optimalTilingLayoutUUID, from->optimalTilingLayoutUUID, VK_UUID_SIZE * sizeof(uint8_t));
}
    ...
    VkQueueFamilyGlobalPriorityProperties* to)
{
    ...
    *to = *from;
    ...
    memcpy(to->priorities, from->priorities, VK_MAX_GLOBAL_PRIORITY_SIZE * sizeof(VkQueueGlobalPriority));
}
    ...
    VkPipelineVertexInputDivisorStateCreateInfo* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pVertexBindingDivisors = (VkVertexInputBindingDivisorDescription*)alloc->alloc(from->vertexBindingDivisorCount * sizeof(const VkVertexInputBindingDivisorDescription));
            to->vertexBindingDivisorCount = from->vertexBindingDivisorCount;
            for (uint32_t i = 0; i < (uint32_t)from->vertexBindingDivisorCount; ++i)
            {
                deepcopy_VkVertexInputBindingDivisorDescription(alloc, rootType, from->pVertexBindingDivisors + i, (VkVertexInputBindingDivisorDescription*)(to->pVertexBindingDivisors + i));
            }
        }
    }
}
    ...
    VkDeviceImageSubresourceInfo* to)
{
    ...
    *to = *from;
    ...
    if (from->pSubresource)
    {
        ...
        deepcopy_VkImageSubresource2(alloc, rootType, from->pSubresource, (VkImageSubresource2*)(to->pSubresource));
    }
}
    ...
    VkRenderingAttachmentLocationInfo* to)
{
    ...
    *to = *from;
    ...
    {
        to->pColorAttachmentLocations = (uint32_t*)alloc->dupArray(from->pColorAttachmentLocations, from->colorAttachmentCount * sizeof(const uint32_t));
    }
}
    ...
    VkRenderingInputAttachmentIndexInfo* to)
{
    ...
    *to = *from;
    ...
    {
        to->pColorAttachmentInputIndices = (uint32_t*)alloc->dupArray(from->pColorAttachmentInputIndices, from->colorAttachmentCount * sizeof(const uint32_t));
    }
    to->pDepthInputAttachmentIndex = nullptr;
    if (from->pDepthInputAttachmentIndex)
    {
        to->pDepthInputAttachmentIndex = (uint32_t*)alloc->dupArray(from->pDepthInputAttachmentIndex, sizeof(const uint32_t));
    }
    to->pStencilInputAttachmentIndex = nullptr;
    if (from->pStencilInputAttachmentIndex)
    {
        to->pStencilInputAttachmentIndex = (uint32_t*)alloc->dupArray(from->pStencilInputAttachmentIndex, sizeof(const uint32_t));
    }
}
    ...
    VkBindDescriptorSetsInfo* to)
{
    ...
    *to = *from;
    ...
    {
        to->pDescriptorSets = (VkDescriptorSet*)alloc->dupArray(from->pDescriptorSets, from->descriptorSetCount * sizeof(const VkDescriptorSet));
    }
    to->pDynamicOffsets = nullptr;
    if (from->pDynamicOffsets)
    {
        to->pDynamicOffsets = (uint32_t*)alloc->dupArray(from->pDynamicOffsets, from->dynamicOffsetCount * sizeof(const uint32_t));
    }
}
    ...
    VkPushDescriptorSetInfo* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        {
            to->pDescriptorWrites = (VkWriteDescriptorSet*)alloc->alloc(from->descriptorWriteCount * sizeof(const VkWriteDescriptorSet));
            to->descriptorWriteCount = from->descriptorWriteCount;
            for (uint32_t i = 0; i < (uint32_t)from->descriptorWriteCount; ++i)
            {
                deepcopy_VkWriteDescriptorSet(alloc, rootType, from->pDescriptorWrites + i, (VkWriteDescriptorSet*)(to->pDescriptorWrites + i));
            }
        }
    }
}
    ...
    VkCopyMemoryToImageInfo* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            to->pRegions = (VkMemoryToImageCopy*)alloc->alloc(from->regionCount * sizeof(const VkMemoryToImageCopy));
            to->regionCount = from->regionCount;
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkMemoryToImageCopy(alloc, rootType, from->pRegions + i, (VkMemoryToImageCopy*)(to->pRegions + i));
            }
        }
    }
}
    ...
    VkCopyImageToMemoryInfo* to)
{
    ...
    *to = *from;
    ...
    if (from)
    {
        ...
        if (from->pRegions)
        {
            to->pRegions = (VkImageToMemoryCopy*)alloc->alloc(from->regionCount * sizeof(const VkImageToMemoryCopy));
            to->regionCount = from->regionCount;
            for (uint32_t i = 0; i < (uint32_t)from->regionCount; ++i)
            {
                deepcopy_VkImageToMemoryCopy(alloc, rootType, from->pRegions + i, (VkImageToMemoryCopy*)(to->pRegions + i));
            }
        }
    }
}
    ...
    VkNativeBufferANDROID* to)
{
    ...
    *to = *from;
    ...
    deepcopy_VkNativeBufferUsage2ANDROID(alloc, rootType, &from->usage2, (VkNativeBufferUsage2ANDROID*)(&to->usage2));
}
    ...
    void* structExtension_out)
{
    ...
    switch(structType)
    {
        ...
        {
            deepcopy_VkShaderModuleCreateInfo(alloc, rootType, reinterpret_cast<const VkShaderModuleCreateInfo*>(structExtension), reinterpret_cast<VkShaderModuleCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO:
        {
            deepcopy_VkPipelineLayoutCreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineLayoutCreateInfo*>(structExtension), reinterpret_cast<VkPipelineLayoutCreateInfo*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_VERSION_1_1
        ...
        {
            deepcopy_VkPhysicalDeviceVulkan13Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceVulkan13Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceVulkan13Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceVulkan13Properties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceVulkan13Properties*>(structExtension), reinterpret_cast<VkPhysicalDeviceVulkan13Properties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO:
        {
            deepcopy_VkPipelineCreationFeedbackCreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineCreationFeedbackCreateInfo*>(structExtension), reinterpret_cast<VkPipelineCreationFeedbackCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES:
        {
            deepcopy_VkPhysicalDeviceShaderTerminateInvocationFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceShaderTerminateInvocationFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceShaderTerminateInvocationFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES:
        {
            deepcopy_VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES:
        {
            deepcopy_VkPhysicalDevicePrivateDataFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDevicePrivateDataFeatures*>(structExtension), reinterpret_cast<VkPhysicalDevicePrivateDataFeatures*>(structExtension_out));
            break;
        }
        ...
        {
            deepcopy_VkPhysicalDevicePipelineCreationCacheControlFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDevicePipelineCreationCacheControlFeatures*>(structExtension), reinterpret_cast<VkPhysicalDevicePipelineCreationCacheControlFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_MEMORY_BARRIER_2:
        {
            deepcopy_VkMemoryBarrier2(alloc, rootType, reinterpret_cast<const VkMemoryBarrier2*>(structExtension), reinterpret_cast<VkMemoryBarrier2*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES:
        {
            deepcopy_VkPhysicalDeviceSynchronization2Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceSynchronization2Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceSynchronization2Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES:
        {
            deepcopy_VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES:
        {
            deepcopy_VkPhysicalDeviceImageRobustnessFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceImageRobustnessFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceImageRobustnessFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES:
        {
            deepcopy_VkPhysicalDeviceSubgroupSizeControlFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceSubgroupSizeControlFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceSubgroupSizeControlFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceSubgroupSizeControlProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceSubgroupSizeControlProperties*>(structExtension), reinterpret_cast<VkPhysicalDeviceSubgroupSizeControlProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO:
        {
            deepcopy_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineShaderStageRequiredSubgroupSizeCreateInfo*>(structExtension), reinterpret_cast<VkPipelineShaderStageRequiredSubgroupSizeCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES:
        {
            deepcopy_VkPhysicalDeviceInlineUniformBlockFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceInlineUniformBlockFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceInlineUniformBlockFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceInlineUniformBlockProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceInlineUniformBlockProperties*>(structExtension), reinterpret_cast<VkPhysicalDeviceInlineUniformBlockProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK:
        {
            deepcopy_VkWriteDescriptorSetInlineUniformBlock(alloc, rootType, reinterpret_cast<const VkWriteDescriptorSetInlineUniformBlock*>(structExtension), reinterpret_cast<VkWriteDescriptorSetInlineUniformBlock*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO:
        {
            deepcopy_VkDescriptorPoolInlineUniformBlockCreateInfo(alloc, rootType, reinterpret_cast<const VkDescriptorPoolInlineUniformBlockCreateInfo*>(structExtension), reinterpret_cast<VkDescriptorPoolInlineUniformBlockCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES:
        {
            deepcopy_VkPhysicalDeviceTextureCompressionASTCHDRFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceTextureCompressionASTCHDRFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceTextureCompressionASTCHDRFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO:
        {
            deepcopy_VkPipelineRenderingCreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineRenderingCreateInfo*>(structExtension), reinterpret_cast<VkPipelineRenderingCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES:
        {
            deepcopy_VkPhysicalDeviceDynamicRenderingFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceDynamicRenderingFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceDynamicRenderingFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDERING_INFO:
        {
            deepcopy_VkCommandBufferInheritanceRenderingInfo(alloc, rootType, reinterpret_cast<const VkCommandBufferInheritanceRenderingInfo*>(structExtension), reinterpret_cast<VkCommandBufferInheritanceRenderingInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_FEATURES:
        {
            deepcopy_VkPhysicalDeviceShaderIntegerDotProductFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceShaderIntegerDotProductFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceShaderIntegerDotProductFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceShaderIntegerDotProductProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceShaderIntegerDotProductProperties*>(structExtension), reinterpret_cast<VkPhysicalDeviceShaderIntegerDotProductProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceTexelBufferAlignmentProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceTexelBufferAlignmentProperties*>(structExtension), reinterpret_cast<VkPhysicalDeviceTexelBufferAlignmentProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_3:
        {
            deepcopy_VkFormatProperties3(alloc, rootType, reinterpret_cast<const VkFormatProperties3*>(structExtension), reinterpret_cast<VkFormatProperties3*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES:
        {
            deepcopy_VkPhysicalDeviceMaintenance4Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceMaintenance4Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceMaintenance4Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceMaintenance4Properties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceMaintenance4Properties*>(structExtension), reinterpret_cast<VkPhysicalDeviceMaintenance4Properties*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_VERSION_1_4
        ...
        {
            deepcopy_VkPhysicalDeviceVulkan14Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceVulkan14Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceVulkan14Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceVulkan14Properties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceVulkan14Properties*>(structExtension), reinterpret_cast<VkPhysicalDeviceVulkan14Properties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO:
        {
            deepcopy_VkDeviceQueueGlobalPriorityCreateInfo(alloc, rootType, reinterpret_cast<const VkDeviceQueueGlobalPriorityCreateInfo*>(structExtension), reinterpret_cast<VkDeviceQueueGlobalPriorityCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES:
        {
            deepcopy_VkPhysicalDeviceGlobalPriorityQueryFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceGlobalPriorityQueryFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceGlobalPriorityQueryFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES:
        {
            deepcopy_VkQueueFamilyGlobalPriorityProperties(alloc, rootType, reinterpret_cast<const VkQueueFamilyGlobalPriorityProperties*>(structExtension), reinterpret_cast<VkQueueFamilyGlobalPriorityProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES:
        {
            deepcopy_VkPhysicalDeviceShaderSubgroupRotateFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceShaderSubgroupRotateFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceShaderSubgroupRotateFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES:
        {
            deepcopy_VkPhysicalDeviceShaderFloatControls2Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceShaderFloatControls2Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceShaderFloatControls2Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES:
        {
            deepcopy_VkPhysicalDeviceShaderExpectAssumeFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceShaderExpectAssumeFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceShaderExpectAssumeFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES:
        {
            deepcopy_VkPhysicalDeviceLineRasterizationFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceLineRasterizationFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceLineRasterizationFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceLineRasterizationProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceLineRasterizationProperties*>(structExtension), reinterpret_cast<VkPhysicalDeviceLineRasterizationProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO:
        {
            deepcopy_VkPipelineRasterizationLineStateCreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineRasterizationLineStateCreateInfo*>(structExtension), reinterpret_cast<VkPipelineRasterizationLineStateCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceVertexAttributeDivisorProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceVertexAttributeDivisorProperties*>(structExtension), reinterpret_cast<VkPhysicalDeviceVertexAttributeDivisorProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO:
        {
            deepcopy_VkPipelineVertexInputDivisorStateCreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineVertexInputDivisorStateCreateInfo*>(structExtension), reinterpret_cast<VkPipelineVertexInputDivisorStateCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES:
        {
            deepcopy_VkPhysicalDeviceVertexAttributeDivisorFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceVertexAttributeDivisorFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceVertexAttributeDivisorFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES:
        {
            deepcopy_VkPhysicalDeviceIndexTypeUint8Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceIndexTypeUint8Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceIndexTypeUint8Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES:
        {
            deepcopy_VkPhysicalDeviceMaintenance5Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceMaintenance5Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceMaintenance5Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceMaintenance5Properties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceMaintenance5Properties*>(structExtension), reinterpret_cast<VkPhysicalDeviceMaintenance5Properties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_CREATE_FLAGS_2_CREATE_INFO:
        {
            deepcopy_VkPipelineCreateFlags2CreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineCreateFlags2CreateInfo*>(structExtension), reinterpret_cast<VkPipelineCreateFlags2CreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_BUFFER_USAGE_FLAGS_2_CREATE_INFO:
        {
            deepcopy_VkBufferUsageFlags2CreateInfo(alloc, rootType, reinterpret_cast<const VkBufferUsageFlags2CreateInfo*>(structExtension), reinterpret_cast<VkBufferUsageFlags2CreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES:
        {
            deepcopy_VkPhysicalDevicePushDescriptorProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDevicePushDescriptorProperties*>(structExtension), reinterpret_cast<VkPhysicalDevicePushDescriptorProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES:
        {
            deepcopy_VkPhysicalDeviceDynamicRenderingLocalReadFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceDynamicRenderingLocalReadFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceDynamicRenderingLocalReadFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_LOCATION_INFO:
        {
            deepcopy_VkRenderingAttachmentLocationInfo(alloc, rootType, reinterpret_cast<const VkRenderingAttachmentLocationInfo*>(structExtension), reinterpret_cast<VkRenderingAttachmentLocationInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDERING_INPUT_ATTACHMENT_INDEX_INFO:
        {
            deepcopy_VkRenderingInputAttachmentIndexInfo(alloc, rootType, reinterpret_cast<const VkRenderingInputAttachmentIndexInfo*>(structExtension), reinterpret_cast<VkRenderingInputAttachmentIndexInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES:
        {
            deepcopy_VkPhysicalDeviceMaintenance6Features(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceMaintenance6Features*>(structExtension), reinterpret_cast<VkPhysicalDeviceMaintenance6Features*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceMaintenance6Properties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceMaintenance6Properties*>(structExtension), reinterpret_cast<VkPhysicalDeviceMaintenance6Properties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_MEMORY_STATUS:
        {
            deepcopy_VkBindMemoryStatus(alloc, rootType, reinterpret_cast<const VkBindMemoryStatus*>(structExtension), reinterpret_cast<VkBindMemoryStatus*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES:
        {
            deepcopy_VkPhysicalDevicePipelineProtectedAccessFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDevicePipelineProtectedAccessFeatures*>(structExtension), reinterpret_cast<VkPhysicalDevicePipelineProtectedAccessFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES:
        {
            deepcopy_VkPhysicalDevicePipelineRobustnessFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDevicePipelineRobustnessFeatures*>(structExtension), reinterpret_cast<VkPhysicalDevicePipelineRobustnessFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES:
        {
            deepcopy_VkPhysicalDevicePipelineRobustnessProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDevicePipelineRobustnessProperties*>(structExtension), reinterpret_cast<VkPhysicalDevicePipelineRobustnessProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_ROBUSTNESS_CREATE_INFO:
        {
            deepcopy_VkPipelineRobustnessCreateInfo(alloc, rootType, reinterpret_cast<const VkPipelineRobustnessCreateInfo*>(structExtension), reinterpret_cast<VkPipelineRobustnessCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES:
        {
            deepcopy_VkPhysicalDeviceHostImageCopyFeatures(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceHostImageCopyFeatures*>(structExtension), reinterpret_cast<VkPhysicalDeviceHostImageCopyFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES:
        {
            deepcopy_VkPhysicalDeviceHostImageCopyProperties(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceHostImageCopyProperties*>(structExtension), reinterpret_cast<VkPhysicalDeviceHostImageCopyProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_SUBRESOURCE_HOST_MEMCPY_SIZE:
        {
            deepcopy_VkSubresourceHostMemcpySize(alloc, rootType, reinterpret_cast<const VkSubresourceHostMemcpySize*>(structExtension), reinterpret_cast<VkSubresourceHostMemcpySize*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY:
        {
            deepcopy_VkHostImageCopyDevicePerformanceQuery(alloc, rootType, reinterpret_cast<const VkHostImageCopyDevicePerformanceQuery*>(structExtension), reinterpret_cast<VkHostImageCopyDevicePerformanceQuery*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_incremental_present
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_PROPERTIES_EXT:
        {
            switch(rootType)
            {
                ...
                case VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO:
                {
                    deepcopy_VkCreateBlobGOOGLE(alloc, rootType, reinterpret_cast<const VkCreateBlobGOOGLE*>(structExtension), reinterpret_cast<VkCreateBlobGOOGLE*>(structExtension_out));
                    break;
                }
                default:
                {
        ...
        {
            deepcopy_VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT*>(structExtension), reinterpret_cast<VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GRAPHICS_PIPELINE_LIBRARY_PROPERTIES_EXT:
        {
            deepcopy_VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT*>(structExtension), reinterpret_cast<VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_LIBRARY_CREATE_INFO_EXT:
        {
            deepcopy_VkGraphicsPipelineLibraryCreateInfoEXT(alloc, rootType, reinterpret_cast<const VkGraphicsPipelineLibraryCreateInfoEXT*>(structExtension), reinterpret_cast<VkGraphicsPipelineLibraryCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_ycbcr_2plane_444_formats
        ...
        {
            deepcopy_VkPhysicalDeviceImageCompressionControlFeaturesEXT(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceImageCompressionControlFeaturesEXT*>(structExtension), reinterpret_cast<VkPhysicalDeviceImageCompressionControlFeaturesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_IMAGE_COMPRESSION_CONTROL_EXT:
        {
            deepcopy_VkImageCompressionControlEXT(alloc, rootType, reinterpret_cast<const VkImageCompressionControlEXT*>(structExtension), reinterpret_cast<VkImageCompressionControlEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_IMAGE_COMPRESSION_PROPERTIES_EXT:
        {
            deepcopy_VkImageCompressionPropertiesEXT(alloc, rootType, reinterpret_cast<const VkImageCompressionPropertiesEXT*>(structExtension), reinterpret_cast<VkImageCompressionPropertiesEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_4444_formats
        ...
        {
            deepcopy_VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT(alloc, rootType, reinterpret_cast<const VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT*>(structExtension), reinterpret_cast<VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT*>(structExtension_out));
            break;
        }
#endif
        default:
